...
<input type="hidden" name="id" value="${form.id}">
 ...
 %>
		...
		<tr>
			<td>Barcode:</td>
			<td><input name="barcode" value="${form.barcode}" readonly="readonly"></td>
		</tr>	
		<tr>
			<td>Kartonid:</td>
		...
		<tr>
		 ...
		 <tr>
			<td>Mandant:</td>
			<td><input type="text" name="mandant" value="${form.mandant}" readonly="readonly"></td>
		</tr>
		<tr>
			<td>Istgewicht:</td>
		...
		<tr>
			...
			<td><input type="text" name="lieferscheinnummer" value="${form.lieferscheinnummer}" readonly="readonly"></td>
		</tr>
			<tr>
			<td>Transportauftragsnummer:</td>
			<td><input type="text" name="transportauftragsnummer" value="${form.transportauftragsnummer}" readonly="readonly"></td>
		</tr>
			<tr>
			<td>Versandart:</td>
			...
			<td><input type="text" name="bearbeitungsstation" value="${form.bearbeitungsstation}" readonly="readonly"></td>
		</tr>
		</tr>
			<tr>
			<td>Letztesupdate:</td>
			...
			<td><label name="manuellAngelegt" value="${form.manuellAngelegt}"></td>
		</tr>
